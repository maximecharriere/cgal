   ...
   */
    ...
    namespace internal
    {
      ...
      template <typename Scalar,
                ...
                typename PM_matrix>
      void
      copy_cgal_points_to_pm_matrix(const PointRange &prange, PointMap point_map, VectorMap vector_map, ScalarMap scalar_map, PM_matrix &pm_points, PM_matrix &pm_normals, PM_matrix& pm_weights)
      {
        int idx = 0;
	  ...
	  template <typename Scalar,
		  ...
		  typename PM_matrix>
		  void
		  copy_cgal_points_to_pm_matrix(const PointRange& prange, PointMap point_map, VectorMap vector_map, PM_matrix& pm_points, PM_matrix& pm_normals)
	  {
		  int idx = 0;
		  for (const auto& p : prange)
		  {
                                          ...
                                          ICP<typename Kernel::FT> icp)
      {
        ...
        typename Kernel::Aff_transformation_3 cgal_transform(pm_transform_params(0, 0), pm_transform_params(0, 1), pm_transform_params(0, 2), pm_transform_params(0, 3),
...
*/
...
#else
    std::pair<typename CGAL::Point_set_processing_3::GetK<PointRange1, NamedParameters1>::Kernel::Aff_transformation_3, float>
#endif
    ...
    std::pair<typename CGAL::Point_set_processing_3::GetK<PointRange1,
                                                          Named_function_parameters<bool, internal_np::all_default_t>>::Kernel::Aff_transformation_3,
              float>
    compute_registration_transformation(const PointRange1 &point_set_1, const PointRange2 &point_set_2)
    {
      namespace params = CGAL::Point_set_processing_3::parameters;
