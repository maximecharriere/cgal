...
CGAL_add_named_parameter(property_map_t, property_map, property_map) // FLIGHTHELMET MODIF
CGAL_add_named_parameter(weight_map_t, weight_map, weight_map) // FLIGHTHELMET MODIF